...
export const UNICLOUD_DIR = 'unicloud';

export const APP_SRC_DIR = 'src';
...
export const UNICLOUD_INDEX_FILE = 'index.js';
export const UNICLOUD_ALIYUN_DIR = 'uniCloud-aliyun';
export const UNICLOUD_TENCENT_DIR = 'uniCloud-tencent';
